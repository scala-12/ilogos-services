...
create table user_roles (
	...
	role varchar(255) check (
		role in ('ROLE_STUDENT','ROLE_ADMIN','ROLE_TEACHER','ROLE_MANAGER','ROLE_EDITOR')
	),
...
create index idx_users_email_username_password ON app_user (email, username, password);
